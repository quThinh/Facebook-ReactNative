      ...
      <View style={styles.container}>
        <View style={styles.topFansWrapper}>
          ...
          <View style={styles.topFans}>
            ...
            >
              You 're a top fans! Keep engagin with this{" "}
            </Text>
            <Text
              style={{
                color: "#333",
            ...
            >
              Page to maintain your top fan status{" "}
            </Text>
          </View>
        ...
        <View style={styles.introduction}>
          ...
          <ExTouchableOpacity style={styles.introLine}>
            ...
            <View>
              ...
              >
                See what {page.name} is doing in Messenger
              </Text>
              <Text
                style={{
                  color: "#318bfb",
