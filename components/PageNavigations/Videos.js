...
class Videos extends Component {
  ...
  render() {
    ...
    const mostPopularVideo = videos.filter(
      (video) => video.isPopular === true
    )[0];
    let reactionValue = 0;
    ...
    return (
      <View style={styles.container}>
        <ExTouchableOpacity
          onPress={this.onPressWatchVideoHandler.bind(
            this,
            mostPopularVideo.id,
            mostPopularVideo.watch_threadId
          )}
          activeOpacity={1}
              ...
              >
                ...
                <View style={styles.videoInfoWrapper}>
                  ...
                  >
                    ...
                    >
                      {Object.values(video.reactions).reduce(
                        (a, b) => a + b,
                        0
                      )}{" "}
                      people liked
