        ...
        >
          <TouchableOpacity
            ...
            style={{
              ...styles.btnCategory,
              backgroundColor:
                currentCategory === resultTypes.ALL ? "#318bfb" : "#ddd",
            }}
          >
            <Text
              style={{
                fontSize: 14,
                fontWeight: "500",
                color: currentCategory === resultTypes.ALL ? "#fff" : "#000",
              }}
            >
              ALL
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.btnCategory,
              backgroundColor:
                currentCategory === resultTypes.POST ? "#318bfb" : "#ddd",
            }}
          >
            <Text
              style={{
                fontSize: 14,
                fontWeight: "500",
                color: currentCategory === resultTypes.POST ? "#fff" : "#000",
              }}
            >
              POSTS
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.btnCategory,
              backgroundColor:
                currentCategory === resultTypes.PEOPLE ? "#318bfb" : "#ddd",
            }}
          >
            <Text
              style={{
                fontSize: 14,
                fontWeight: "500",
                color: currentCategory === resultTypes.PEOPLE ? "#fff" : "#000",
              }}
            >
              PEOPLE
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.btnCategory,
              backgroundColor:
                currentCategory === resultTypes.EVENT ? "#318bfb" : "#ddd",
            }}
          >
            <Text
              style={{
                fontSize: 14,
                fontWeight: "500",
                color: currentCategory === resultTypes.EVENT ? "#fff" : "#000",
              }}
            >
              EVENT
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.btnCategory,
              backgroundColor:
                currentCategory === resultTypes.PAGE ? "#318bfb" : "#ddd",
            }}
          >
            <Text
              style={{
                fontSize: 14,
                fontWeight: "500",
                color: currentCategory === resultTypes.PAGE ? "#fff" : "#000",
              }}
            >
              PAGES
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              ...styles.btnCategory,
              backgroundColor:
                currentCategory === resultTypes.VIDEO ? "#318bfb" : "#ddd",
            }}
          >
            <Text
              style={{
                fontSize: 14,
                fontWeight: "500",
                color: currentCategory === resultTypes.VIDEO ? "#fff" : "#000",
              }}
            >
              VIDEO
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              marginRight: 15,
              backgroundColor:
                currentCategory === resultTypes.IMAGE ? "#318bfb" : "#ddd",
            }}
          >
            <Text
              style={{
                fontSize: 14,
                fontWeight: "500",
                color: currentCategory === resultTypes.IMAGE ? "#fff" : "#000",
              }}
            >
              IMAGES
            </Text>
        ...
        >
          <Peoples
            hidden={
              ...
              currentCategory !== resultTypes.PEOPLE
            }
            isShowPreview={currentCategory !== resultTypes.PEOPLE}
            showAllFn={this.onPressChangeCategoryHandler.bind(
              this,
              resultTypes.PEOPLE
            )}
          />
          <Posts
            hidden={
              currentCategory !== resultTypes.ALL &&
              currentCategory !== resultTypes.POST
            }
