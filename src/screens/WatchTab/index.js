...
class index extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return (
      JSON.stringify(user) !== JSON.stringify(nextUser) ||
          ...
          >
            <View style={styles.titleWrapper}>
              ...
              <View style={styles.rightOptionWrapper}>
                ...
                <ExTouchableOpacity
                  onPress={this.onPressWatchSearchHandler}
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    setWatchingVideo: (playingId, isPlaying = true) =>
      dispatch(SetWatchingVideo(playingId, isPlaying)),
  };
};
