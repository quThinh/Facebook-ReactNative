      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            <FontAwesome5Icon
              name="arrow-left"
              size={20}
              color={isOverScrollLimit ? "#000" : "#fff"}
            />
          </ExTouchableOpacity>
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={this.onPressChangeTabHandler.bind(
                  this,
                  pageNavigationTypes.HOME
                )}
                style={{
                  ...styles.tab,
                  borderBottomWidth:
                    currentNavigationTab === pageNavigationTypes.HOME ? 2 : 0,
                }}
              >
                <Text
                  style={{
              ...
              <TouchableOpacity
                onPress={this.onPressChangeTabHandler.bind(
                  this,
                  pageNavigationTypes.INTRODUCTION
                )}
                style={{
                  ...styles.tab,
                  borderBottomWidth:
              ...
              <TouchableOpacity
                onPress={this.onPressChangeTabHandler.bind(
                  this,
                  pageNavigationTypes.POSTS
                )}
                style={{
                  ...styles.tab,
                  borderBottomWidth:
                    currentNavigationTab === pageNavigationTypes.POSTS ? 2 : 0,
                }}
              >
                <Text
                  style={{
              ...
              <TouchableOpacity
                onPress={this.onPressChangeTabHandler.bind(
                  this,
                  pageNavigationTypes.VIDEOS
                )}
                style={{
                  ...styles.tab,
                  borderBottomWidth:
                    currentNavigationTab === pageNavigationTypes.VIDEOS ? 2 : 0,
                }}
              >
                <Text
                  style={{
              ...
              <TouchableOpacity
                onPress={this.onPressChangeTabHandler.bind(
                  this,
                  pageNavigationTypes.PHOTOS
                )}
                style={{
                  ...styles.tab,
                  borderBottomWidth:
                    currentNavigationTab === pageNavigationTypes.PHOTOS ? 2 : 0,
                }}
              >
                <Text
                  style={{
              ...
              <TouchableOpacity
                onPress={this.onPressChangeTabHandler.bind(
                  this,
                  pageNavigationTypes.EVENT
                )}
                style={{
                  ...styles.tab,
                  borderBottomWidth:
                    currentNavigationTab === pageNavigationTypes.EVENT ? 2 : 0,
                }}
              >
                <Text
                  style={{
              ...
              <TouchableOpacity
                onPress={this.onPressChangeTabHandler.bind(
                  this,
                  pageNavigationTypes.COMMUNICATION
                )}
                style={{
                  ...styles.tab,
                  marginRight: 20,
        ...
        >
          <View style={styles.wrapper}>
            <Image
              style={styles.cover}
              source={{ uri: pageDetail.cover_url }}
            />
            <View style={styles.Info}>
              <View style={styles.mainInfo}>
                <Image
                  source={{ uri: pageDetail.avatar_url }}
                  style={styles.avatar}
                />
              ...
              <View style={styles.friendsLikePage}>
                ...
                >
                  {friendsLikePage
                    .splice(0, 3)
                    .map((friend) => friend.name.split(" ")[1])
                    .join(", ")}{" "}
                  and {pageDetail.like_count} another people liked this page.
                </Text>
              </View>
            </View>
            <ScrollView
            ...
            >
              <View
                style={{
                  width: SCREEN_WIDTH,
                  opacity:
                    currentNavigationTab === pageNavigationTypes.HOME ? 1 : 0,
                  height:
                    currentNavigationTab === pageNavigationTypes.HOME
                      ? "auto"
                      : 0,
              ...
              <View
                style={{
                  width: SCREEN_WIDTH,
                  opacity:
                    currentNavigationTab === pageNavigationTypes.POSTS ? 1 : 0,
                  height:
                    currentNavigationTab === pageNavigationTypes.POSTS
                      ? "auto"
                      : 0,
              ...
              <View
                style={{
                  width: SCREEN_WIDTH,
                  opacity:
                    currentNavigationTab === pageNavigationTypes.VIDEOS ? 1 : 0,
                  height:
                    currentNavigationTab === pageNavigationTypes.VIDEOS
                      ? "auto"
                      : 0,
              ...
              <View
                style={{
                  width: SCREEN_WIDTH,
                  opacity:
                    currentNavigationTab === pageNavigationTypes.PHOTOS ? 1 : 0,
                  height:
                    currentNavigationTab === pageNavigationTypes.PHOTOS
                      ? "auto"
                      : 0,
              ...
              <View
                style={{
                  width: SCREEN_WIDTH,
                  opacity:
                    currentNavigationTab === pageNavigationTypes.EVENT ? 1 : 0,
                  height:
                    currentNavigationTab === pageNavigationTypes.EVENT
                      ? "auto"
                      : 0,
...
const OFFSETY_LIMIT_FOR_FIX_NAVIGATION_BAR =
  250 + 64 + 10 + 15 + 40 + 36 + 30 - STATUSBAR_HEIGHT - 50;
