    ...
    return (
      <View style={styles.container}>
        <View style={styles.navigationBar}>
          ...
          <ExTouchableOpacity activeOpacity={0.8} style={styles.searchInput}>
        ...
        >
          <View style={styles.btnNavigationsWrapper}>
            <TouchableOpacity
              onPress={this.onPressFriendRequestsHandler.bind(this)}
              style={{ ...styles.btnNavigation, marginRight: 10 }}
            >
            ...
            <TouchableOpacity
              onPress={this.onPressAllFriendsHandler.bind(this)}
          ...
          <View style={styles.recommendFriendsWrapper}>
            <Text style={styles.recommendFriendsTitle}>
              People you may know
            </Text>
