      ...
      <View style={styles.container}>
        ...
        <View style={styles.postOptionsWrapper}>
          <ExTouchableOpacity style={styles.postOptionItemWrapper}>
            <View style={styles.postOptionItem}>
              <View style={styles.optionIcon}>
                <FontAwesome5Icon name="crop-alt" size={24}></FontAwesome5Icon>
              </View>
              <View>
          ...
          <ExTouchableOpacity style={styles.postOptionItemWrapper}>
            <View style={styles.postOptionItem}>
              <View style={styles.optionIcon}>
                <FontAwesome5Icon name="video" size={20}></FontAwesome5Icon>
              </View>
              <View>
          ...
          <ExTouchableOpacity
            ...
            onPress={this.onPressSelectProfilePictureHandler}
          >
            <View style={styles.postOptionItem}>
              <View style={styles.optionIcon}>
          ...
          <ExTouchableOpacity style={styles.postOptionItemWrapper}>
            <View style={styles.postOptionItem}>
              <View style={styles.optionIcon}>
                <FontAwesome5Icon name="magic" size={20}></FontAwesome5Icon>
              </View>
              <View>
