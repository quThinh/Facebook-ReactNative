        ...
        <ScrollView bounces={false}>
          <View style={styles.topWrapper}>
            <View style={styles.titleWrapper}>
              ...
              <ExTouchableOpacity
                onPress={this.onPressGroupSearchHandler}
            ...
            >
              <TouchableOpacity style={styles.navigatorItem}>
                <FontAwesome5Icon name="users" size={20}></FontAwesome5Icon>
              ...
              <TouchableOpacity
                style={{ ...styles.navigatorItem, marginRight: 30 }}
              >
                <FontAwesome5Icon name="cog" size={20}></FontAwesome5Icon>
            ...
            >
              {groups.map((group, index) => (
                <View key={index}>
                  {(index < groups.length - 1 || index > 9) && (
                    <TouchableOpacity
                      onPress={this.onPressGoToGroupHandler.bind(
                        this,
                        group.id
                      )}
                      style={{ ...styles.recommendItem, marginRight: 10 }}
                    >
                      {group.isPin && (
              ...
              <TouchableOpacity
                style={{ ...styles.recommendItem, marginRight: 30 }}
              >
                <View style={styles.remainingNumberWrapper}>
                  <Text style={styles.remainingNumber}>
                    +{groups.length > 10 ? groups.length - 10 : 1}
                  </Text>
                </View>
                <Image
                  source={{
                    uri:
                      groups[groups.length > 10 ? 10 : groups.length - 1]
                        .avatar_url,
                  }}
                  style={styles.groupAvatar}
                ></Image>
