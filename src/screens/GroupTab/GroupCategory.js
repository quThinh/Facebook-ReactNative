      ...
      <View style={styles.container}>
        <View
          style={{
            ...
            backgroundColor: searchToolBackground,
            borderBottomColor: searchToolBorderColor,
          }}
        >
          ...
          <ExTouchableOpacity
            onPress={this.onPressGoToSearch}
        ...
        >
          ...
          <ExTouchableOpacity
            onPress={this.onPressGoToSearch}
            style={styles.notFoundYourGroup}
          >
            <Image
            ...
            >
              You didn't see your needing content?
            </Text>
            <Text style={{ fontSize: 14, marginVertical: 10, color: "#333" }}>
              Use keyword for searching
            </Text>
            <ExTouchableOpacity
              onPress={this.onPressGoToSearch}
